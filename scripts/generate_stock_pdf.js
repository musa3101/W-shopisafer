...
<body>
  ...
  <div class="page text-zinc-800">
    ...
    const tempHtmlPath = path.join('/Users/musa/Downloads/sopisafer/scripts', 'stock_preview.html');
    ...
    for (let i = 0; i < pageCount; i++) {
      const imgPath = path.join(BASE_OUTPUT_DIR, `control_inventario_pagina_${i + 1}.png`);
...
function renderTableRow(product) {
  ...
  const image = product.images && product.images[0] ? product.images[0] : 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=80&q=80';
