    ...
    <div className="fixed inset-0 z-40 overflow-y-auto bg-rose-50 dark:bg-rose-950 text-zinc-900 dark:text-zinc-100 flex flex-col font-sans animate-in fade-in duration-300">
      ...
      <section className="relative w-full h-[60vh] sm:h-[75vh] min-h-[420px] bg-zinc-900 overflow-hidden">
        ...
        <div className="absolute bottom-10 left-6 sm:left-12 sm:bottom-16 max-w-2xl text-white space-y-4 pr-6">
          <p className="text-base sm:text-2xl font-serif leading-relaxed text-zinc-100 font-light drop-shadow-md">
            "Desde 2024 creamos moda con sensibilidad, con corazón. No es solo
            diseñar ropa, es poner un poco de alma en cada pieza."
          </p>
      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-10 py-16 sm:py-24 space-y-12">
        ...
        <div className="space-y-6 text-base sm:text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed font-sans font-normal">
          <p>
            Todo empezó en <strong>2024</strong>, con un sueño muy simple: crear
            moda que no fuera solo ropa, sino una manera de sentirse más segura,
            más femenina y llena de confianza. Con un toque elegante pero
            también urbano, porque la ciudad y su energía siempre inspiran.
          </p>

          <p>
            Cada colección nace con mucho cuidado, buscando siluetas modernas y
            detalles delicados. Brooklyn y Nueva York son parte de la esencia,
            su luz, sus calles... y también la pasión de Camila, que desde
            siempre ha amado la moda y el proceso de darle vida a cada prenda.
          </p>

          <p>
            No creemos en tendencias pasajeras, sino en piezas que se sienten
            cómodas, hechas con materiales de calidad, que acompañan a la mujer
            en su día a día. Moda pensada para durar y para expresar la
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center bg-zinc-50 dark:bg-zinc-900/60 p-6 sm:p-10 rounded-3xl border border-zinc-200/80 dark:border-zinc-800">
            ...
            <div className="md:col-span-7 space-y-4">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 text-xs font-black uppercase tracking-widest">
                <Sparkles className="w-3.5 h-3.5" /> Fundadora & Directora
                Creativa
              </div>
              ...
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-300 leading-relaxed">
                "Mi meta en Isafer Boutique es que cada mujer que vista nuestras
                prendas sienta esa magia de verse al espejo y sentirse poderosa,
                sensual y cómoda. Cuidamos cada detalle desde Brooklyn para
                entregarte la mejor experiencia."
              </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Moda femenina sensual, elegante y licras moldeadoras de alta
              compresión en Brooklyn, New York.
            </p>
          </div>
