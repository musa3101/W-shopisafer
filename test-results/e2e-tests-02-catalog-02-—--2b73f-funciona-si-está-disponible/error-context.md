...
- Name: e2e/tests/02-catalog.spec.ts >> 02 — Catálogo de Productos >> el carrusel Trending/Novedades funciona si está disponible
- Location: e2e/tests/02-catalog.spec.ts:30:3
