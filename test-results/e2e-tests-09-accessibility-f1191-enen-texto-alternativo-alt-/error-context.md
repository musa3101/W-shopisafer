...
- Name: e2e/tests/09-accessibility.spec.ts >> 09 — Accesibilidad y Roles >> las imágenes principales contienen texto alternativo (alt)
- Location: e2e/tests/09-accessibility.spec.ts:5:3
