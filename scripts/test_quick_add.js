...
async function run() {
  try {
    ...
    const addButton = page
      .locator('[data-testid="add-to-cart-button-mobile"]')
      .first();
    ...
    console.log(
      "Mobile QuickAddOverlay status:",
      JSON.stringify(overlayStatus, null, 2),
    );
    ...
    console.log(
      "Desktop Modal status:",
      JSON.stringify(desktopModalStatus, null, 2),
    );
