...
export const SEL = {
  ...
  cartIcon: '[aria-label*="carrito" i], [aria-label*="cart" i], button:has(svg)',
  userIcon: '[aria-label*="cuenta" i], [aria-label*="user" i], [aria-label*="account" i]',
  menuHamburger: '[aria-label*="menú" i], [aria-label*="menu" i], button:has(svg.lucide-menu)',
  ...
  addToCartBtn: 'button:has-text("carrito"), button:has-text("Añadir"), button:has-text("Add")',
  ...
  authSubmitBtn: 'button[type="submit"], button:has-text("Iniciar"), button:has-text("Login")',

  /* ── Newsletter ── */
  newsletterSection: 'footer, [class*="newsletter" i]',
  newsletterInput: 'input[type="email"][placeholder*="email" i], footer input[type="email"]',
  newsletterSubmit: 'footer button[type="submit"], [class*="newsletter" i] button',
