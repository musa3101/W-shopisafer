  ...
  try {
    ...
    if (error) {
      ...
      if (signUpResult.error) {
        console.log('❌ Falló también el registro del administrador:', signUpResult.error.message);
      } else {
        console.log('✅ Administrador registrado exitosamente en el backend de InsForge!');
