        ...
        <Tabs defaultValue="client" className="w-full mt-4">
          ...
          <TabsContent value="client" className="space-y-3 pt-4">
            ...
            <Button
              ...
              className="w-full py-5 rounded-xl border border-input hover:bg-slate-50 transition-all font-semibold text-xs uppercase tracking-wider flex items-center justify-center gap-3 shadow-xs hover:shadow"
            >
              ...
              <span>{isLoading ? "..." : "CONTINUE WITH GOOGLE"}</span>
            </Button>
            ...
            {onAppleSignIn && (
              ...
              >
                ...
                <span>{isLoading ? "..." : "CONTINUE WITH APPLE"}</span>
              </Button>
            )}
          </TabsContent>
          ...
          <TabsContent value="admin" className="space-y-4 pt-4">
            <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs text-slate-700 dark:text-slate-300 space-y-1">
              ...
              <p>
                ...
                <code className="bg-white dark:bg-slate-900 px-1.5 py-0.5 rounded text-rose-600 font-mono">
                  admin
                </code>
              </p>
              <p>
