...
- Name: e2e/tests/03-product-detail.spec.ts >> 03 — Detalle de Producto Modal >> hacer clic en un producto abre el modal de detalles
- Location: e2e/tests/03-product-detail.spec.ts:5:3
