...
async function captureLiveAudit() {
  ...
  try {
    ...
    await page.goto('http://localhost:5173/admin/catalogo', { waitUntil: 'networkidle' });
    await sleep(2000);
    ...
    await page.goto('http://localhost:5173/admin/pedidos', { waitUntil: 'networkidle' });
    await sleep(2000);
    ...
    await page.goto('http://localhost:5173/admin/ajustes', { waitUntil: 'networkidle' });
    await sleep(2000);
