          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <h2 className="font-serif text-2xl sm:text-3xl font-black text-white leading-tight">
                Empoderar a la mujer a través de prendas exclusivas y llenas de
                actitud. 💖
              </h2>

              <div className="space-y-3 text-xs sm:text-sm text-zinc-300 leading-relaxed font-sans">
                <p>
                  Todo empezó en <strong>2024</strong>, con un sueño muy claro:
                  crear ropa que no fuera solo una prenda más, sino una forma de
                  sentirte más segura, más libre y radiantemente femenina. Con
                  un toque sofisticado pero lleno de la energía urbana de Nueva
                  York, que siempre nos inspira.
                </p>

                <p>
                  Cada colección nace con un cuidado minucioso, seleccionando
                  tejidos moldeadores premium, cortes favorecedores y detalles
                  delicados. <strong>Isafer Boutique</strong> es el reflejo del
                  amor por la moda y de la pasión de Camila por cuidar
                  personalmente a cada clienta.
                </p>

                <p>
                  No creemos en tendencias pasajeras, sino en piezas cómodas y
                  de alta calidad que destacan tus curvas y te acompañan en tus
                  momentos más especiales. Moda hecha para durar y hacer brillar
              ...
              <div className="pt-4 border-t border-zinc-850 flex items-center justify-between">
                <div>
                  <p className="text-[11px] font-semibold text-rose-400">
                    Con cariño y gratitud, seguimos creando para ti.
                  </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-zinc-850">
            <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-850 space-y-1.5">
              ...
              <p className="text-[11px] text-zinc-400">
                Licras de alta compresión inteligente que estilizan y potencian
                tu figura natural.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-850 space-y-1.5">
              ...
              <p className="text-[11px] text-zinc-400">
                Tejidos ultrasuaves, sin transparencias no deseadas y
            ...
            <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-850 space-y-1.5">
              ...
              <p className="text-[11px] text-zinc-400">
                Asesoría directa por WhatsApp y entregas en tiempo récord desde
                Brooklyn.
              </p>
            </div>
          </div>
