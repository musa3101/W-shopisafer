...
1. **Modal de Políticas Legales Interactivo**:
   ...
   - Los enlaces del Footer ("Política de Privacidad", "Términos y Condiciones", "Cookies") y el del Banner de Cookies ahora abren este modal interactivo.
...
- `src/routes/index.tsx` (Footer, Dialog de políticas, y lógica de apertura de modales).
